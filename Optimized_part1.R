...
# If using less movements
#move_data = move.data
#move.data = readRDS("../Data/sub.move.data_50%.rds")
#move.data = readRDS("../Data/sub.move.data.slaughter_50%.rds")
move.data = readRDS("../Data/sub.move.data_reduce66%.rds")
...
# Save
saveRDS(Output_list, file.path("../Data", "trans_bac_reduceMove66.rds"))
